...
export class DeleteUserComponent {
  ...
  constructor(public dialogRef: MatDialogRef<DeleteUserComponent>, @Inject(MAT_DIALOG_DATA) public data: { userId: string }, private firestore: Firestore,  private router: Router, private dialog: MatDialog) {
